        ...
        <Form className="flex flex-col gap-5 w-full" onSubmit={onSubmit}>
          ...
          >
            ...
            <div className="relative flex items-center">
              <User size={16} className="text-gray-400 absolute left-3" />
              <Input
          ...
          >
            ...
            <div className="relative flex items-center">
              {/* Using Link icon for a URL field, matching the input pattern */}
              <span className="text-gray-400 absolute left-3 text-sm font-medium">
                http://
              </span>
              <Input
                type="text"
                placeholder="https://example.com/image.jpg"
                className="rounded-sm bg-gray-50/80 border border-gray-100 shadow-none h-11 w-full pl-16 pr-3 outline-none focus:border-[#1FB6CD] transition-colors"
              />
            </div>
            <FieldError className="text-red-500 text-sm" />
          </TextField>
